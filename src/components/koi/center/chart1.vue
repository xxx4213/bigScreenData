...
export default {
  ...
  methods: {
    ...
    getData() {
      this.row1 = [];
      this.row1.push({ name: '生产线1', value: "正常", color: '#33cea0'})
      this.row1.push({ name: '生产线2', value: "正常", color: '#33cea0'})
      this.row1.push({ name: '生产线3', value: "正常", color: '#33cea0'})
      this.row1.push({ name: '生产线4', value: "正常", color: '#33cea0'})
      // this.row1.push({ name: '生产线3', value: "正常", color: 'tomato' })
      // this.row1.push({ name: '生产线4', value: "正常", color: 'tomato' })
      ...
      this.row2 = [];
      this.row2.push({ name: '今日产量', value: "3550", color: '#33cea0'})
      this.row2.push({ name: '今日产量', value: "3500", color: '#33cea0'})
      this.row2.push({ name: '今日产量', value: "3600", color: '#33cea0'})
      this.row2.push({ name: '今日产量', value: "3800", color: '#33cea0'})         
